...
### 🔧 SRE Dashboard Essentials

Your AI service dashboard should include:
1. **Token Usage** - Line chart of tokens over time (cost proxy)
2. **Request Rate** - Requests per minute (capacity planning)
3. **Response Time** - P50, P95, P99 latency (SLA tracking)
4. **Error Rate** - Failed requests percentage (reliability)
5. **Model Distribution** - Which models are being used (cost optimization)
...
### 9.3 Example Tile: Token Cost Estimation
